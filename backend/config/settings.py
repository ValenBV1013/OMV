...
SUPABASE_URL = "https://qadhizboonbuzqbposhl.supabase.co"   # Reemplazar con tu URL real
SUPABASE_KEY = "Michel2008*"                               # Reemplazar con tu clave real
SUPABASE_ANON_KEY = SUPABASE_KEY                           # Misma clave anónima

# --- TomTom Traffic API (predicción de tráfico) ---
TOMTOM_API_KEY = "fhvnnw5SW0qDawcZPR0aBUK1zyy0SUSO"                         # Obtener de https://developer.tomtom.com
